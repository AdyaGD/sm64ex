COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       ...
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE")        , _("THE 7TH STAR"))
...
COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S FORTRESS"),
       ...
       _("RED COINS ON THE FLOATING ISLE"), _("FALL ONTO THE CAGED ISLAND")    , _("BLAST AWAY THE WALL")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_JRB, _(" 3 JOLLY ROGER BAY"),
       ...
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL MOUNTAIN"),
       _("SLIP SLIDIN' AWAY")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL WORK")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S HAUNT"),
       ...
       _("SEEK THE 8 RED COINS")          , _("BIG BOO'S BALCONY")             , _("EYE TO EYE IN THE SECRET ROOM")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 HAZY MAZE CAVE"),
       ...
       _("NAVIGATING THE TOXIC MAZE")     , _("A-MAZE-ING EMERGENCY EXIT")     , _("WATCH FOR ROLLING ROCKS")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_LLL, _(" 7 LETHAL LAVA LAND"),
       _("BOIL THE BIG BULLY")            , _("BULLY THE BULLIES")             , _("8-COIN PUZZLE WITH 15 PIECES"),
       _("RED-HOT LOG ROLLING")           , _("HOT-FOOT-IT INTO THE VOLCANO")  , _("ELEVATOR TOUR IN THE VOLCANO")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_SSL, _(" 8 SHIFTING SAND LAND"),
       ...
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("PYRAMID PUZZLE")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_DDD, _(" 9 DIRE, DIRE DOCKS"),
       _("BOARD BOWSER'S SUB")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
       _("THROUGH THE JET STREAM")        , _("THE MANTA RAY'S REWARD")        , _("COLLECT THE CAPS...")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_SL, _("10 SNOWMAN'S LAND"),
       _("SNOWMAN'S BIG HEAD")            , _("CHILL WITH THE BULLY")          , _("IN THE DEEP FREEZE"),
       _("WHIRL FROM THE FREEZING POND")  , _("SHELL SHREDDIN' FOR RED COINS") , _("INTO THE IGLOO")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WDW, _("11 WET-DRY WORLD"),
       _("SHOCKING ARROW LIFTS!")         , _("TOP O' THE TOWN")               , _("SECRETS IN THE SHALLOWS & SKY"),
       _("EXPRESS ELEVATOR--HURRY UP!")   , _("GO TO TOWN FOR RED COINS")      , _("QUICK RACE THROUGH DOWNTOWN!")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_TTM, _("12 TALL, TALL MOUNTAIN"),
       ...
       _("MYSTERIOUS MOUNTAINSIDE")       , _("BREATHTAKING VIEW FROM BRIDGE") , _("BLAST TO THE LONELY MUSHROOM")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_THI, _("13 TINY-HUGE ISLAND"),
       ...
       _("FIVE ITTY BITTY SECRETS")       , _("WIGGLER'S RED COINS")           , _("MAKE WIGGLER SQUIRM")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_TTC, _("14 TICK TOCK CLOCK"),
       _("ROLL INTO THE CAGE")            , _("THE PIT AND THE PENDULUMS")     , _("GET A HAND"),
       _("STOMP ON THE THWOMP")           , _("TIMED JUMPS ON MOVING BARS")    , _("STOP TIME FOR RED COINS")        , _("BEHIND CHAIN CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_RR, _("15 RAINBOW RIDE"),
       ...
       _("SWINGIN' IN THE BREEZE")        , _("TRICKY TRIANGLES!")             , _("SOMEWHERE OVER THE RAINBOW")        , _("BEHIND CHAIN CHOMP'S GATE"))
